      ...
      <div className="flex justify-center items-center select-none px-4 md:px-0">
        <div className="grid grid-cols-1 w-[85%] my-2 sm:my-6 text-[#000]">
          ...
          <div className="text-[15px] mt-3 pp:text-[18px] ">
            Welcome to Grovyo! This Shipping and Delivery Policy outlines the
            terms and procedures for shipping and delivery of products ordered
            through our web application &quot;Web App&quot; and mobile
            application &quot;Mobile App&quot;. Please read this policy
            carefully before placing an order. By making a purchase on our
            platform, you agree to adhere to the terms set forth in this policy.
          </div>
